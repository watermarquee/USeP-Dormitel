    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <a class="btn btn-large btn-block btn-danger" href="/quarter" role="button"
                   style="border-radius:0">Affordable</a>
            </div>
            <div class="col-md-4">
                <img src='images/dummy.gif' alt="Image" vspace="20" hspace="15"
                     style="width:250px;height:250px;border:0;">
                <a class="btn btn-large btn-block btn-danger" href="/middlequarter" role="button"
                   style="border-radius:0">Middle class</a>
            </div>
            <div class="col-md-4">
                <img src='images/dummy.gif' alt="Image" vspace="20" hspace="15"
                     style="width:250px;height:250px;border:0;">
                <a class="btn btn-large btn-block btn-danger" href="/vip" role="button"
